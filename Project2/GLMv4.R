...
glmdata$weight_group <- cut(glmdata$Weight, 
                            breaks = c(-Inf,1000,3681,6151,Inf), 
                            labels = c("01_<1000kg", "02_1000-3680years", "03_3681-6150years", "04_>=6151years"), 
                            right = FALSE)

glmdata$age_group <- cut(glmdata$VehicleAge, 
                         breaks = c(-Inf,5,12,19,Inf), 
                         labels = c("01_<5years", "02_5-11years", "03_12-18years", "04_>=19years"), 
                         right = FALSE)
...
write.xlsx(glmdata3, "factors4.xlsx")
